/**********************************************************************************************************************
* Description: This is the implementation file for the Living class. It is a child of the abstract Spaces class. It
...
std::string Living::getRoomName() {
	return currentSpace;
}

// displays the items in the room
void Living::getItems() {
...
void Living::setMoves(Space* room) {
	// intentionally left empty
}

void Living::setMoves(Space* room1, Space* room2) {
	roomVects[0] = room1;
	roomVects[1] = nullptr;
	roomVects[2] = nullptr;
	roomVects[3] = room2;
...
void Living::setMoves(Space* room1, Space* room2, Space* room3, Space* room4, Space* room5) {
	// // intentionally left empty
}

// the effect of the interaction, if any
void Living::interact(int choice) {
	// intentionally left empty
}
...
std::string Living::removeItem(int index) {
